...
export class MusicService {
  ...
  getDiscList(query: object): Observable<ResDto> {
    ...
    return this.httpWrap.getReq(url, query, this.qqHeaders)
      .pipe(
        map(resData => this.parseRes(resData))
      )
  }
  ...
  getLyric(query: object): Observable<ResDto> {
    ...
    return this.httpWrap.getReq(url, query)
      .pipe(
        map(resData => this.parseRes(resData))
      )
  }
  ...
  getSongsUrl(body: object): Observable<ResDto> {
    ...
    return this.httpWrap.postReq(url, body)
      .pipe(
        map(resData => {
